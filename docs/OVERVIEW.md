...
| OpenClaw | 18789 (loopback) | no public UI; Signal pending account secret | [docs/services/openclaw.md](services/openclaw.md) |
...
| Frigate Notifier | systemd service | paused; ntfy/email notifier config kept for later re-enable | [docs/services/frigate-notifier.md](services/frigate-notifier.md) |
