...
| Frigate Notifier | systemd service | ntfy push alerts for camera2 people/cars with email fallback | [docs/services/frigate-notifier.md](services/frigate-notifier.md) |
